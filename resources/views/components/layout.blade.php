...
<section class="px-6 py-8">
    <nav class="md:flex md:justify-between md:items-center">
        ...
        <div class="mt-8 md:mt-0">
            ...
            @else
                <a href="/login"
                   class="bg-blue-500 ml-3 rounded-full text-xs font-semibold text-white uppercase py-3 px-5">Login
                </a>

                <a href="/register"
                   class="bg-blue-500 ml-3 rounded-full text-xs font-semibold text-white uppercase py-3 px-5">Register
                </a>
            @endauth
